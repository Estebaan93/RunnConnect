...
public class BuscarInscripcionesFragment extends Fragment {
  ...
  public void onResume(){
    ...
    if (binding != null) {
      binding.searchViewBusqueda.setQuery("", false); // "" borra el texto, false evita que busque de nuevo
      binding.searchViewBusqueda.clearFocus(); // Quita el foco para que no salte el teclado
    }
